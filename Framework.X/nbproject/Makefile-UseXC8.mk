...
${OBJECTDIR}/_ext/1213600618/ColorSensor.p1: ../../../PicRouter2-master/src/ColorSensor.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1213600618 
	@${RM} ${OBJECTDIR}/_ext/1213600618/ColorSensor.p1.d 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G --asmlist  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=none,+asm,-asmfile,+speed,-space,-debug,9 --addrqual=ignore --mode=free -P -N255 --warn=0 --summary=default,-psect,-class,+mem,-hex,-file --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib "--errformat=%%f:%%l: error: %%s" "--warnformat=%%f:%%l: warning: %%s" "--msgformat=%%f:%%l: advisory: %%s"  -o${OBJECTDIR}/_ext/1213600618/ColorSensor.p1  ../../../PicRouter2-master/src/ColorSensor.c 
	@-${MV} ${OBJECTDIR}/_ext/1213600618/ColorSensor.d ${OBJECTDIR}/_ext/1213600618/ColorSensor.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1213600618/ColorSensor.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
